...
/**
 * The URIConnectionConfig contains all the parameters
 * needed to establish the connection with the MongoDB database.
 */
public class URIConnectionConfig {
    ...
    public void setConnectionURI(String connectionURI) throws MongoConnectorException {
