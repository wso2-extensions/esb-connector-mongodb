...
/**
 * Class mediator for deleting many documents.
 * For more information, see https://docs.mongodb.com/manual/reference/method/db.collection.deleteMany
 */
public class DeleteMany extends AbstractConnectorOperation {
    ...
    private static final String ERROR_MESSAGE = "Error occurred while deleting the documents from the database.";
    ...
    public void execute(MessageContext messageContext, String responseVariable, Boolean overwriteBody)
        ...
        try {
            ...
            JSONObject deleteResult = simpleMongoClient.deleteManyDocuments(collection, queryDoc, collation);
