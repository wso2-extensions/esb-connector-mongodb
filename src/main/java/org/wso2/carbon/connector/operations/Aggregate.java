...
public class Aggregate extends AbstractConnectorOperation {
    ...
    public void execute(MessageContext messageContext, String responseVariable, Boolean overwriteBody) throws ConnectException {
        ...
        String stagesStrings = getMediatorParameter(messageContext, STAGES, String.class, false);
        ...
        try {
            ...
            JSONObject aggregationResult = simpleMongoClient.aggregationPipeline(collection, stages);

            if (log.isDebugEnabled()) {
                log.debug(AGGREGATION_RESULT + aggregationResult);
            }
            handleConnectorResponse(messageContext, responseVariable, overwriteBody, aggregationResult.toString(),
                    null, null);
